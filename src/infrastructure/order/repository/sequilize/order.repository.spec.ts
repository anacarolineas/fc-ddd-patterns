...
describe("Order repository test", () => {
  ...
  it("should find a order", async () => {
    ...
    expect(orderModel.toJSON()).toStrictEqual({
      ...
      items: [
        {
          id: orderFounded.items[0].id,
          name: orderFounded.items[0].name,
          price: orderFounded.items[0].price,
          quantity: orderFounded.items[0].quantity,
          order_id: orderFounded.id,
          product_id: orderFounded.items[0].productId,
        },
      ],
    });
  });
